package com.techinnoveta.hackerrank.duplicatewords;
...
public class TestRegexFindText {
	public static void main(String[] args) {
		...
		// Step 1: Compile a regex via static method Pattern.compile(), default
		// is case-sensitive
		Pattern pattern = Pattern.compile(regexStr);
		// Pattern.compile(regex, Pattern.CASE_INSENSITIVE); // for
		...
		// Try Matcher.lookingAt(), which tries to match from the beginning of
		// the input string
